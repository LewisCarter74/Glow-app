...
export default function PromotionsPage() {
  const loyaltyPoints = 250; // Placeholder
    ...
    <div className="container mx-auto px-4 py-16">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <Card className="bg-card shadow-lg border-primary/20 flex flex-col">
          ...
          <CardContent className="flex-grow">
            <p className="text-muted-foreground text-lg">
              Enjoy <span className="font-bold text-foreground">20% off</span> your first service with us!
            </p>
        ...
        <Card className="bg-card shadow-lg border-accent/20 flex flex-col">
          ...
          <CardFooter>
            <Button variant="outline" className="w-full">Redeem Loyalty Points</Button>
          </CardFooter>
        </Card>
        ...
        <Card className="bg-card shadow-lg border-secondary-foreground/20 flex flex-col">
          ...
          <CardContent className="flex-grow">
            <p className="text-muted-foreground text-lg">
              Get <span className="font-bold text-foreground">100 points</span> for every friend who signs up and books an appointment!
            </p>
          </CardContent>
          <CardFooter>
