# Generated by Django 5.2 on 2025-07-23 08:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='services', to='salon.category')),
            ],
        ),
        migrations.CreateModel(
            name='Stylist',
